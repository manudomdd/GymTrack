...
public class AIGeneralChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai_general_chat);
        ...
        tvName.setText("Asistente General");
        ...
        messages.add(new ChatMessage("ai", "¡Hola! Soy tu asistente de IA general. Estoy a tu disposición para ayudarte con cualquier duda relacionada a tus planes de entrenamiento, biomecánica, dudas sobre nutrición deportiva, periodización y control de la fatiga. ¿Qué te gustaría consultar hoy?"));
        ...
        new Thread(() -> {
            try {
                ...
                try (Response response = httpClient.newCall(request).execute()) {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        runOnUiThread(() -> {
                            pbLoading.setVisibility(View.GONE);
                            btnSend.setEnabled(true);
                            Toast.makeText(AIGeneralChatActivity.this, "Error del servidor: " + response.code(), Toast.LENGTH_SHORT).show();
                        });
                    }
                }
            } catch (Exception e) {
                ...
                runOnUiThread(() -> {
                    pbLoading.setVisibility(View.GONE);
                    btnSend.setEnabled(true);
                    Toast.makeText(AIGeneralChatActivity.this, "Error de red: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
            }
        }).start();
    }
